...
if (WIN32)
    ...
    find_dx_header      (DDRAW   ddraw.h)
    find_dx_library     (DDRAW   ddraw)
    ...
    find_dx_header      (D3D     d3d.h)
    find_combined       (D3D     D3D DDRAW)

    find_dx_header      (D3DX    d3dx.h)
    find_combined       (D3DX    D3DX D3DX)

    find_dx_header      (D3D8    d3d8.h)
    find_dx_library     (D3D8    d3d8)
    find_combined       (D3D8    D3D8 D3D8)

    find_dx_header      (D3DX8   d3dx8.h)
    find_dx_library     (D3DX8   d3dx8)
    find_combined       (D3DX8   D3DX8 D3DX8)

    find_dx_header      (D3D9    d3d9.h)
    find_dx_library     (D3D9    d3d9)
    find_combined       (D3D9    D3D9 D3D9)

    find_dx_header      (D3DX9   d3dx9.h)
    find_dx_library     (D3DX9   d3dx9)
    find_combined       (D3DX9   D3DX9 D3DX9)

    if (NOT WINDOWS_XP)
        find_dx_header      (DXGI    dxgi.h)
        find_dx_header      (DXGI1_2 dxgi1_2.h)
        find_dx_header      (DXGI1_3 dxgi1_3.h)
        find_dx_library     (DXGI    dxgi)

        find_dx_header      (D3D10   d3d10.h)
        find_dx_library     (D3D10   d3d10)
        find_combined       (D3D10   D3D10 D3D10)

        find_dx_header      (D3D10_1 d3d10_1.h)
        find_dx_library     (D3D10_1 d3d10_1)
        find_combined       (D3D10_1 D3D10_1 D3D10_1)

        find_dx_header      (D3DX10  d3dx10.h)
        find_dx_library     (D3DX10  d3dx10)
        find_combined       (D3DX10  D3DX10 D3DX10)

        find_dx_header      (D3D11   d3d11.h)
        find_dx_library     (D3D11   d3d11)
        find_combined       (D3D11   D3D11 D3D11)
        find_dx_header      (D3D11_1 d3d11_1.h)
        find_combined       (D3D11_1 D3D11_1 D3D11)
        find_dx_header      (D3D11_2 d3d11_2.h)
        find_combined       (D3D11_2 D3D11_2 D3D11)

        find_dx_header      (D3DX11  d3dx11.h)
        find_dx_library     (D3DX11  d3dx11)
        find_combined       (D3DX11  D3DX11 D3DX11)

        find_dx_header      (D2D1    d2d1.h)
        find_dx_library     (D2D1    d2d1)
